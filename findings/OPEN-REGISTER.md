...
| NS-003 | BSC base declares 0–1 (`engine/rollup.py:90`) but runner adds pack deltas directly (`round/runner.py:376`); Balanced R1 Financial -26.033068 | `recovery/scorecard-contract` | **OPEN; M0 gate. Contract REVIEWED.** Independent PASS at `0716eb9`, R1–R4 accepted in handoff `review.md`; implementation not dispatched. Closing checks will be N1–N8 in its spec, including persisted Balanced R1 Financial 0.696932 and partial-status evidence. No numeric correction is claimed yet. |
