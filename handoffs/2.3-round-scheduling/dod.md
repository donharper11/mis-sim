...
| Reversible migration and one-clock-read entrypoint | migration/guard tests | pending |
| Two-instance/different-pack schedule and seed | cohort scheduling probe | pending |
