...
□  Casepack registry schema, two-pack binding, cache/digest negatives, and append-only operations evidence complete (`backend/tests/test_casepack_registry.py`, `backend/tests/check_casepack_registry_schema.py`)
